package com.edu.gdmec.s07150825.thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void threadclass() {
        class ThreadSamlpe extends Thread {
            Random rm;

            public ThreadSamlpe(String tname) {
                super(tname);
                rm = new Random();
        ...
        ThreadSamlpe thread1 = new ThreadSamlpe("线程一");
        thread1.start();
        ThreadSamlpe thread2 = new ThreadSamlpe("线程二");
        thread2.start();
